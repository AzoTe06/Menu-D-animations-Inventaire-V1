...
function PersonnalMenu()
    ...
    Menu.addButton("Ma carte d'identité", "openGuiIdentity", nil)
...
function animsMenu()
    ...
    ClearMenu()
    Menu.addButton("Animations Salut", "animsSalute", nil)
    Menu.addButton("Animations Humeur", "animsHumor", nil)
    Menu.addButton("Animations Sportives", "animsSportives",nil)
    Menu.addButton("Animations Festives", "animsFestives",nil)
